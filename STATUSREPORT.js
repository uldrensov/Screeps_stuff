...
module.exports = {
    run: function(room_num){
        ...
        if (Memory.bloodhunter_MAX[room_num] > 0) console.log('Blood hunters: ' + bloodhunter_gang.length + '/' + Memory.bloodhunter_MAX[room_num]);
        if (Memory.enforcer_MAX[room_num] > 0) console.log('Enforcers: ' + enforcer_gang.length + '/' + Memory.enforcer_MAX[room_num]);
        if (Memory.purifier_MAX[room_num] > 0) console.log('Purifiers: ' + purifier_gang.length + '/' + Memory.purifier_MAX[room_num]);
